...
> B-树的每个节点都有data域（指针），这无疑增大了节点大小，说白了增加了磁盘IO次数（磁盘IO一次读出的数据量大小是固定的，单个数据变大，每次读出的就少，IO次数增多，一次IO多耗时）， 而B+树除了叶子节点其它节点并不存储数据，节点小，磁盘IO次数就少
...
<img src = "..\..\..\..\picture service\dataStructures\119.png">

<img src = "..\..\..\..\picture service\dataStructures\120.png">

<img src = "..\..\..\..\picture service\dataStructures\121.png">